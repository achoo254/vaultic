...
export function showSaveBanner(
  ...
  // Remove existing banner host
  document.getElementById('vaultic-save-banner-host')?.remove();
  ...
  host.id = 'vaultic-save-banner-host';
  ...
  banner.className = 'vaultic-save-banner';
  ...
  banner.querySelector('.vaultic-sb-close')!.addEventListener('click', remove);
